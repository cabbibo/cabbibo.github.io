...

  {
    ...
    links: [
...

      {
        ...
        info: `I was asked to give a talk at Pixar a bunch of years ago, and as usual decided the *right* thing to was to make an entire 'engine' for the talk instead of just using powerpoint. 
        <br/><br/>
        later Natalie Sun asked me to present a similar object at Next Art Night, so I tried to cut it down into something more playful. 
        <br/>
        This is the result.
        `,
        mobile: false
